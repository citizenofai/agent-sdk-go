...
cd "${REPO_ROOT}"
go mod init github.com/citizenofai/agent-sdk-go
echo "replace github.com/citizenofai/agent-sdk-go => ${REPO_ROOT}" >> go.mod
go mod tidy
...
echo "Visit https://goreportcard.com/report/github.com/citizenofai/agent-sdk-go to see your score." 