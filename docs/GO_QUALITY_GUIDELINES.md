...
Current status: [![Go Report Card](https://goreportcard.com/badge/github.com/citizenofai/agent-sdk-go)](https://goreportcard.com/report/github.com/citizenofai/agent-sdk-go)
